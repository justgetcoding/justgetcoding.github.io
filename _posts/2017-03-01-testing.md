...
langauge starting with should. **__This makes the test intent easily readable.__** Inside the it block we do two things. Run the function and test the result.
